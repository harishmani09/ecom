...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # messages.success(
            #     request,
            #     "Thank you for registering. Pls verify your account by clicking the verification link sent to your email id.",
            # )
...
def forgot_password(request):
    if request.method == "POST":
        ...
        if Account.objects.filter(email=email).exists():
            ...
            messages.success(
                request, "password reset mail has been sent to your email id"
            )
            return redirect("login")
        else:
